        ...
        <div class="glass-card mt-4">
            ...
            <div class="glass-card-body text-center py-5">
                <div class="mb-4">
                    ...
                    <div style="font-size: 2rem; font-weight: 700; color: var(--primary-accent); font-family: monospace;"><?php echo e($nim); ?></div>
                </div>
                ...
                <form method="POST" action="<?php echo e(route('mahasiswa.capture.run')); ?>" id="captureForm" class="d-inline-block">
                    <?php echo csrf_field(); ?>
                    ...
                    <a href="<?php echo e(route('mahasiswa.index')); ?>" class="btn-modern btn-secondary-modern btn-lg px-4 py-3 mx-2">
                        Kembali
                    </a>
                </form>
