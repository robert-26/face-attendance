    ...
    <div class="col-md-8 col-lg-6">
        <div class="glass-card shadow-lg text-center" style="border-radius: 30px; overflow: visible;">
            ...
            <div class="glass-card-body pt-4 pb-5 px-4 px-md-5">
                ...
                <form method="POST" action="<?php echo e(route('absen.run')); ?>">
                    <?php echo csrf_field(); ?>
                ...
                <?php if(session('result')): ?>
                    <div class="alert alert-modern alert-success-modern mt-4 text-start">
                        ...
                        <pre class="mb-0" style="color: var(--text-main); font-family: 'Courier New', Courier, monospace; font-size: 0.9rem; white-space: pre-wrap; word-wrap: break-word;"><?php echo e(session('result')); ?></pre>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="text-center mt-4">
            <p style="color: var(--text-muted); font-size: 0.85rem;">
                <span style="opacity: 0.7;">&copy; <?php echo e(date('Y')); ?> Sistem Presensi Wajah.</span>
            </p>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Face_Recognition_PCD\face-attendance\backend\resources\views/absen/index.blade.php ENDPATH**/ ?>