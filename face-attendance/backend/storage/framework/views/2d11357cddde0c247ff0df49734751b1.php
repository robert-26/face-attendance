...
<div class="page-header">
    ...
    <div style="font-size:.75rem;color:var(--text-muted);">
        Total: <strong style="color:#a5b4fc"><?php echo e(count($mahasiswas)); ?></strong> mahasiswa
    </div>
</div>
        ...
        <div class="glass-card">
            ...
            <div class="glass-card-header" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:.75rem;">
                ...
                <div style="display:flex; gap:.5rem; align-items:center; flex-wrap:wrap;">
                    ...
                    <a href="<?php echo e(route('train.model')); ?>" class="btn-modern btn-primary-modern" style="padding: .45rem .75rem;" onclick="this.innerHTML='🧠 Memproses...'; this.style.opacity=0.7;">
                        🧠 Latih Model
                    </a>
                    ...
                    <tbody id="mhsBody">
                        <?php $__empty_1 = true; $__currentLoopData = $mahasiswas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr data-search="<?php echo e(strtolower($m->nim . ' ' . $m->nama . ' ' . $m->kelas)); ?>">
                                <td style="color:var(--text-muted);font-size:.7rem;font-weight:500;"><?php echo e($i + 1); ?></td>
            ...
            <div class="tbl-foot">
                <span>Menampilkan <strong id="mhsCount" style="color:var(--text-secondary)"><?php echo e(count($mahasiswas)); ?></strong> dari <?php echo e(count($mahasiswas)); ?> data</span>
