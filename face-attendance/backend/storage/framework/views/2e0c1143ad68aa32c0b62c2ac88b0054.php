...
<div class="page-header">
    ...
    <div style="font-size: 0.8rem; color: rgba(255,255,255,0.3);">
        Diperbarui: <?php echo e(now()->translatedFormat('d M Y, H:i')); ?>
...
<div class="stats-grid">
    ...
    <div class="stat-card-new hadir">
        <div class="stat-icon">✅</div>
        <div class="stat-num"><?php echo e($totalHadir); ?></div>
        <div class="stat-lbl">Hadir · <?php echo e($pctHadir); ?>%</div>
        <div class="stat-bar"><div class="stat-bar-fill" id="barHadir" style="width:0%"></div></div>
    </div>
    <div class="stat-card-new izin">
        <div class="stat-icon">📝</div>
        <div class="stat-num"><?php echo e($totalIzin); ?></div>
        <div class="stat-lbl">Izin · <?php echo e($pctIzin); ?>%</div>
        <div class="stat-bar"><div class="stat-bar-fill" id="barIzin" style="width:0%"></div></div>
    </div>
    <div class="stat-card-new alpha">
        <div class="stat-icon">❌</div>
        <div class="stat-num"><?php echo e($totalAlpha); ?></div>
        <div class="stat-lbl">Alpha · <?php echo e($pctAlpha); ?>%</div>
...
<div class="table-card">
    ...
    <div class="table-responsive">
        <table class="atbl" id="absensiTable">
            ...
            <tbody id="tableBody">
                <?php $__empty_1 = true; $__currentLoopData = $absensi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        $sc       = strtolower($data->status ?? 'alpha');
                        if (!in_array($sc, ['hadir','izin','alpha'])) $sc = 'alpha';
                        $initials = strtoupper(substr($data->nama ?? '?', 0, 1));
                    ?>
                    <tr data-nim="<?php echo e(strtolower($data->nim)); ?>"
                        data-nama="<?php echo e(strtolower($data->nama)); ?>"
                        data-kelas="<?php echo e(strtolower($data->kelas)); ?>"
                        data-status="<?php echo e($sc); ?>">

                        <td><span class="row-num"><?php echo e($i + 1); ?></span></td>

                        <td><span class="nim-chip"><?php echo e($data->nim); ?></span></td>

                        <td>
                            <div class="av-wrap">
                                <div class="av"><?php echo e($initials); ?></div>
                                <div>
                                    <div class="av-name"><?php echo e($data->nama); ?></div>
                                    <div class="av-kelas"><?php echo e($data->kelas); ?></div>
                                </div>
                            </div>
                        </td>

                        <td><span class="date-txt"><?php echo e(\Carbon\Carbon::parse($data->tanggal)->translatedFormat('d M Y')); ?></span></td>

                        <td><span class="time-chip"><?php echo e($data->waktu); ?></span></td>

                        <td>
                            <span class="sbadge <?php echo e($sc); ?>">
    ...
    <div class="tbl-footer" id="tableFooter">
        <div>Menampilkan <strong style="color:rgba(255,255,255,0.55)" id="visibleCount"><?php echo e($total); ?></strong> dari <?php echo e($total); ?> record</div>
        <div class="tbl-footer-badge">
            <span>📅</span> <?php echo e(now()->translatedFormat('d M Y')); ?>
...
<script>
    ...
    window.addEventListener('load', () => {
        setTimeout(() => {
            ...
            if (barHadir) barHadir.style.width = '<?php echo e($pctHadir); ?>%';
            if (barIzin)  barIzin.style.width  = '<?php echo e($pctIzin); ?>%';
            if (barAlpha) barAlpha.style.width  = '<?php echo e($pctAlpha); ?>%';
        }, 200);
    });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Face_Recognition_PCD\face-attendance\backend\resources\views/absensi/index.blade.php ENDPATH**/ ?>