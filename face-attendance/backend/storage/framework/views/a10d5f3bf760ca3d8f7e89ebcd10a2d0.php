...
<div class="glass-card mb-4">
    <div class="glass-card-body d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            ...
            <div style="font-size: 1.25rem; font-weight: 700; color: #fff;"><?php echo e(now()->translatedFormat('l, d F Y')); ?></div>
        </div>
        <div class="text-end">
            ...
            <div style="font-size: 1.25rem; font-weight: 700; color: #f87171;"><?php echo e($deadline); ?> WIB</div>
        </div>
    </div>
</div>
