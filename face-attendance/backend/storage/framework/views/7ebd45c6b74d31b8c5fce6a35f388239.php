    ...
    <div class="col-md-8 col-lg-6">
        ...
        <div class="glass-card">
            <div class="glass-card-header">
                Mahasiswa: <span style="font-family:'Inter',monospace;color:#a5b4fc;font-weight:700;margin-left:.25rem;"><?php echo e($nim); ?></span>
            </div>
            <div class="glass-card-body text-center" style="padding:2rem 1.5rem;">
                ...
                <form method="POST" action="<?php echo e(route('mahasiswa.capture.run')); ?>" id="captureForm" class="d-inline-flex gap-2">
                    <?php echo csrf_field(); ?>
                    ...
                    <a href="<?php echo e(route('mahasiswa.index')); ?>" class="btn-modern btn-secondary-modern" style="padding:.6rem 1.25rem;">
                        Kembali
                    </a>
                </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Face_Recognition_PCD\face-attendance\backend\resources\views/mahasiswa/capture.blade.php ENDPATH**/ ?>